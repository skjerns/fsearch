...
typedef struct FsearchTray FsearchTray;

FsearchTray *
fsearch_tray_new(FsearchApplication *app);

// TRUE if an actual tray icon is present (built with appindicator support and
// the indicator was created). Used to decide whether the app can safely hide
